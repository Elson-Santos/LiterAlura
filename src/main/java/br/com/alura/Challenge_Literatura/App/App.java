...
public class App {
    ...
    private void listarTop10LivrosMaisBaixados() {
        ...
        // Ordenar os livros pelo número de downloads em ordem decrescente
        listaLivros.sort((l1, l2) -> Integer.compare(l2.getDownloads(), l1.getDownloads()));

        // Limitar a lista aos top 10
        List<Livro> top10Livros = listaLivros.stream().limit(10).toList();
    ...
    private void buscarLivro() {
        System.out.print("Digite o nome do livros para buscar: ");
